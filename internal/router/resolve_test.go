...
func TestResolve(t *testing.T) {
	cases := []struct {
		...
		{name: "deepseek flash", model: "deepseek-flash",
			want: router.Decision{Backend: router.BackendDeepSeek, UpstreamModel: "deepseek-flash", ClientModel: "deepseek-flash", EffortSource: router.EffortSourceNone}},
		{name: "deepseek legacy flash canonicalized", model: "deepseek-v4-flash",
			want: router.Decision{Backend: router.BackendDeepSeek, UpstreamModel: "deepseek-flash", ClientModel: "deepseek-v4-flash", EffortSource: router.EffortSourceNone}},
		{name: "deepseek legacy vision flash canonicalized", model: "deepseek-v4-flash-vision-exp",
			want: router.Decision{Backend: router.BackendDeepSeek, UpstreamModel: "deepseek-flash", ClientModel: "deepseek-v4-flash-vision-exp", EffortSource: router.EffortSourceNone}},
		{name: "deepseek pro", model: "deepseek-v4-pro",
			want: router.Decision{Backend: router.BackendDeepSeek, UpstreamModel: "deepseek-v4-pro", ClientModel: "deepseek-v4-pro", EffortSource: router.EffortSourceNone}},
		{name: "deepseek picker flash survives restart", model: "anthropic-compat.deepseek-flash",
			want: router.Decision{Backend: router.BackendDeepSeek, UpstreamModel: "deepseek-flash", ClientModel: "anthropic-compat.deepseek-flash", EffortSource: router.EffortSourceNone}},
		{name: "deepseek picker pro survives restart", model: "anthropic-compat.deepseek-v4-pro",
			want: router.Decision{Backend: router.BackendDeepSeek, UpstreamModel: "deepseek-v4-pro", ClientModel: "anthropic-compat.deepseek-v4-pro", EffortSource: router.EffortSourceNone}},
		...
		{name: "unknown deepseek name is rejected instead of silently mapped upstream", model: "deepseek-v5-ultra", wantErr: true},

...
// staticAnthropicModels is the fallback Anthropic catalog: what utraque advertises
...
var staticAnthropicModels = []anthropic.CatalogModel{
...
// StaticAnthropicModels returns a copy of the built-in Anthropic fallback list.
func StaticAnthropicModels() []anthropic.CatalogModel {
	out := make([]anthropic.CatalogModel, len(staticAnthropicModels))
	copy(out, staticAnthropicModels)
	return out
}
